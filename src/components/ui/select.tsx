...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-gray-200 border-2 placeholder:text-muted-foreground " +
          ...
          "focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:border-gray-200 " +
      ...
      <SelectPrimitive.Content
        ...
        className={cn(
          "border-gray-200 border-2 placeholder:text-muted-foreground " +
            ...
            "rounded-md shadow-md outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 " +
