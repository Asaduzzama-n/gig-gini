...
const getStepIcon = (stepName: string) => {
  const iconMap: { [key: string]: React.ReactElement } = {
    ...
    'Role Play': <Handshake className="w-4 h-4" />,
...
>
  <div className="text-center space-y-4 px-4">
    <Badge className="bg-[#FC5602]/10 text-[#FC5602] border-[#FC5602]/20 mb-4">
...
<div className="pt-4 border-t border-gray-100">
  <motion.button
    ...
    whileTap={{ scale: 0.97 }}
    className="w-full bg-gradient-to-r from-[#FC5602] to-[#FF7B02] text-white font-semibold py-3 px-5 rounded-lg flex items-center justify-center space-x-2 shadow-md hover:shadow-lg transition-all duration-300"
  >
